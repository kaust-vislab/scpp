...
elseif(LSB_DISTRIBUTOR_ID MATCHES "RedHatEnterpriseServer")
  ...
  set(PACKAGE_DIR ${CMAKE_SOURCE_DIR}/../BBPPackages/redhat/el${LSB_RELEASE})
else()
  message(STATUS "Unknown OS for package-upload")
endif()

add_custom_target(bbp-package-copy
...
add_dependencies(bbp-package bbp-package-copy)
