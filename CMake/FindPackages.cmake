...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Boost 1.41.0 COMPONENTS unit_test_framework program_options thread system filesystem regex)
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    pkg_check_modules(Boost Boost>=1.41.0)
  endif()
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    message(FATAL_ERROR "Could not find Boost COMPONENTS unit_test_framework program_options thread system filesystem regex")
  endif()
else()
  find_package(Boost 1.41.0  REQUIRED unit_test_framework program_options thread system filesystem regex)
endif()
